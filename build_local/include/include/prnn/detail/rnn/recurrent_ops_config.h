...
template<
    ...
    index_t GridTileRows = 544, //1088,
    index_t GridTileColumns = 544, //1088,
    index_t BlockTileRows = 112,//224,
    index_t BlockTileColumns = 112,
    index_t ThreadTileRows = 7,//14,
    index_t ThreadTileColumns = 7, //14,

                            ...
                            size_t reserveSpaceSizeInBytes)
{
    ...
    prnn::rnn::forwardPropRecurrent(activationsView, activationsView, inputView, weightsView, weightsView, weightsView, scratchView,
        scratchView, reserveView, opsHandle); // ADD INPUTS
